...
public class CurrencyIndexLookUp implements ILookUp{
	...
	private CurrencyIndexLookUp(final Map<String, Integer> currencyIndexLookUpMap) {
		this.currencyIndexLookUpMap = currencyIndexLookUpMap;
	}
	public static CurrencyIndexLookUp createCurrencyIndexLookup(final List<String> validatedInputLines) {
